...
export default function Home() {
  return (
    <main className="min-h-screen bg-page-gradient px-4 py-6 text-slate sm:px-6 sm:py-8 lg:px-10">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] border border-white/70 bg-white/70 shadow-panel backdrop-blur xl:max-w-[72rem]">
        ...
        <div className="px-4 pb-12 sm:px-8 sm:pb-16 lg:px-12 lg:pb-20">
          <section className="-mt-8 rounded-[2rem] bg-white px-5 py-7 shadow-[0_22px_65px_rgba(94,109,161,0.16)] sm:-mt-10 sm:px-8 sm:py-10 lg:px-10">
            ...
            <article className="rounded-[2rem] bg-[#253765] px-5 py-7 text-white shadow-sm sm:px-8 sm:py-10">
              ...
              <ul className="mt-6 space-y-4">
                {synthesisPoints.map((point) => (
                  <li key={point} className="flex items-start gap-3 text-base leading-7 text-white/90 sm:text-lg sm:leading-8">
                    <span
